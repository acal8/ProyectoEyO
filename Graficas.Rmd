...
$$Min\{ \dfrac{\gamma}{2} \alpha_t^T \sum_t \alpha_t - \alpha_t^T \mu_t\} \quad \text{s.a} \quad \sum \alpha_t=1$$
...
- Vector $b$: contiene los valores de las restricciones (b_eq y b_ineq).
