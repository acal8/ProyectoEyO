...
kable(t(evals), 
      ...
      col.names = c('RMSE', 'Rendimiento apartado 3.1 (retMV)', 'Utilidad apartado 3.1 (Umv)', 'Rendimiento apartado 3.2 (retMVPos)', 'Utilidad apartado 3.2 (UmvPos)', 'Rendimiento apartado 4 (retLog)', 'Utilidad apartado 4 (ULog)'),
      digits = 4)
```
